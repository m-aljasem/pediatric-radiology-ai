"""
RESTful API Server for Bone Age Prediction
...
app = FastAPI(
    ...
    description="RESTful API for Bone Age Prediction predictions",
    version="1.0.0"
)
...
STATS_PATH = MODELS_DIR / "bone_age_stats.json" if stats_filename else None
...
async def predict(file: UploadFile = File(...)):
    ...
    try:
        ...
        elif len(CLASSES) == 0:  # Regression task (bone age)
